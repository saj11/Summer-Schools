...
TH_WEIGHTS_PATH_NO_TOP = 'models/rcmalli_vggface_th_weights_th_ordering_notop.h5'
TF_WEIGHTS_PATH_NO_TOP = 'models/rcmalli_vggface_tf_weights_tf_ordering_notop.h5'
